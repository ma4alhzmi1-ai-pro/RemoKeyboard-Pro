...
export default function App() {
  ...
  const [studioText, setStudioText] = useState('ريمو كيبورد 1.0.13');
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans antialiased selection:bg-cyan-500 selection:text-black" dir="rtl">
      ...
      <header className="border-b border-slate-800/80 bg-slate-900/70 backdrop-blur-md sticky top-0 z-40">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              href="/RemoKeyboard-1.0.13.apk"
              download="RemoKeyboard-1.0.13.apk"
              className="hidden md:inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold rounded-lg bg-cyan-500/20 text-cyan-300 border border-cyan-500/30 hover:bg-cyan-500/30 active:scale-95 transition-all"
            >
      ...
      <footer className="border-t border-slate-800/80 mt-16 py-8 text-center text-xs text-slate-500 space-y-2">
        ...
        <div className="flex items-center justify-center gap-4 text-[11px] text-slate-400">
          ...
          <span>•</span>
          <a
            href="/remo-keyboard-1.0.13-source.zip"
            download="remo-keyboard-1.0.13-source.zip"
