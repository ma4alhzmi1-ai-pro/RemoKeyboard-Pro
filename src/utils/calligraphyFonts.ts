...
export const CALLIGRAPHY_FONTS: CalligraphyFont[] = [
  ...
  // الخطوط العربية العالمية الحقيقية (Google Fonts Web Fonts)
  {
    ...
    transformChar: (c) => (c === ' ' ? ' ' : c + '̲'),
    transformText: (t) => t.split('').map((c) => (c === ' ' ? ' ' : c + '̲')).join('')
  },
  {
    id: 'tajawal',
    ...
    transformChar: (c) => (c === ' ' ? ' ' : c + '̳'),
    transformText: (t) => t.split('').map((c) => (c === ' ' ? ' ' : c + '̳')).join('')
  },
  {
    id: 'amiri',
    ...
    transformChar: (c) => (c === ' ' ? ' ' : c + 'َ'),
    transformText: (t) => t.split('').map((c) => (c === ' ' ? ' ' : c + 'َ')).join('')
  },
  {
    id: 'aref-ruqaa',
    ...
    transformChar: (c) => (c === ' ' ? ' ' : c + 'ـ'),
    transformText: (t) => t.split('').map((c) => (c === ' ' ? ' ' : c + 'ـ')).join('')
  },
  {
    id: 'marhey',
  ...
  },
  {
    ...
    transformChar: (c) => (c === ' ' ? ' ' : c + 'ُ'),
    transformText: (t) => t.split('').map((c) => (c === ' ' ? ' ' : c + 'ُ')).join('')
  },
  {
    id: 'lemonada',
  ...
  },
  {
    ...
    transformChar: (c) => (c === ' ' ? ' ' : c + 'ٜ'),
    transformText: (t) => t.split('').map((c) => (c === ' ' ? ' ' : c + 'ٜ')).join('')
  },
  {
    id: 'rakkas',
